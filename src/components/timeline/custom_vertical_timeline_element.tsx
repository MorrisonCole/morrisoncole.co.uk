...
export default function CustomVerticalTimelineElement(props: CustomVerticalTimelineElementProps) {
        ...
        >
          ...
          >
            {props.icon}
                    ...
                    >
                        {props.children}
                        <Typography variant="h5" className="vertical-timeline-element-date">{props.date}</Typography>
                    </div>
                </div>
            </VisibilitySensor>
        </div>
