export const meta = {
  title: "MDX Frontmatter to MDX Exports With Deno",
  date: "2020-05-17",
  updated: null,
...
To be honest, this took me _way_ longer than I expected.
...
gave up. I think I'm kind of spoiler by Kotlin, and to be honest the alternative
I went with is just as readable anyway.
...
As the Deno ecosystem develops (or the NPM shim gets finished), I'm sure this
