...
> Update: this post is getting fairly popular, and almost 2 years have passed
> since I first wrote it, so I've [written up some new thoughts](../antidepressants-in-japan-2).

> 🙅 **Disclaimer:** despite working for a medical tech company at the time of
> writing, I know _next to nothing_ about _anything_ in medicine. This post is
> part rant, part PSA, but **absolutely not medical advice!**
