    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { fields?: Maybe<(
          ...
          & { meta?: Maybe<(
            { __typename?: 'MdxExportsMeta' }
            & Pick<MdxExportsMeta, 'draft' | 'title' | 'date' | 'description' | 'linkText'>
            & { image?: Maybe<(
              { __typename?: 'File' }
              & { childImageSharp?: Maybe<(
                { __typename?: 'ImageSharp' }
        ...
        & { rawResult?: Maybe<(
          ...
          & { data?: Maybe<(
            ...
            & { viewer?: Maybe<(
              ...
              & { repositories?: Maybe<(
                { __typename?: 'GithubDataRawResultDataViewerRepositories' }
                & Pick<GithubDataRawResultDataViewerRepositories, 'totalCount'>
                & { nodes?: Maybe<Array<Maybe<(
                  { __typename?: 'GithubDataRawResultDataViewerRepositoriesNodes' }
                  & Pick<GithubDataRawResultDataViewerRepositoriesNodes, 'name' | 'url' | 'updatedAt'>
                  & { primaryLanguage?: Maybe<(
                    { __typename?: 'GithubDataRawResultDataViewerRepositoriesNodesPrimaryLanguage' }
                    & Pick<GithubDataRawResultDataViewerRepositoriesNodesPrimaryLanguage, 'name'>
                  )> }
                )>>> }
              )> }
            )> }
